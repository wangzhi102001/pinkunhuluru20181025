...
准备工作：
    ...
    if input_num == "1":
        ...
        e_to_j.file_to_json_fomat(
            "001.json", "002.json", familyDatas, list_poor_family)
...
for p1 in list_poor_family:    
    if (p1.state == False and p1.error == False):
        ...
        ff.radio_driver(driver,p1.a5,my.a5)
        ff.radio_driver(driver,p1.a6,my.a6)
        ff.radio_driver(driver,p1.a6,my.a7)
        ff.input_driver(driver,p1.a1,my.a1)
        ff.input_driver(driver,p1.a2,my.a2)
        ff.input_driver(driver,p1.a3,my.a3)
        driver.find_element_by_xpath(my.xpath_qiehuan_3).click()  # 切换至三、
        time.sleep(2)
        ff.input_driver(driver,p1.a8,my.a8)
        ff.input_driver(driver,p1.a9,my.a9)
        #ff.input_driver(driver,p1.a10,my.a10)
        ff.input_driver(driver,p1.a11,my.a11)
        ff.input_driver(driver,p1.a12,my.a12)
        ff.input_driver(driver,p1.a13,my.a13)
        ff.input_driver(driver,p1.a14,my.a14)
        ff.input_driver(driver,p1.a15,my.a15)
        ff.input_driver(driver,p1.a16,my.a16)
        ff.input_driver(driver,p1.a17,my.a17)
        ff.input_driver(driver,p1.a18,my.a18)
        ff.input_driver(driver,p1.a19,my.a19)
        driver.find_element_by_xpath(my.xpath_qiehuan_2).click()  # 切换至二、
        time.sleep(2)
        ff.input_driver(driver,p1.a20,my.a20)
        ff.input_driver(driver,p1.a21,my.a21)
        ff.input_driver(driver,p1.a22,my.a22)
        ff.input_driver(driver,p1.a23,my.a23)
        ff.input_driver(driver,p1.a24,my.a24)
        ff.input_driver(driver,p1.a25,my.a25)
        ff.input_driver(driver,p1.a29,my.a29)
        ff.input_driver(driver,p1.a31,my.a31)
        ff.select_driver(driver,p1.a26,my.a26)
        ff.select_driver(driver,p1.a27,my.a27)
        ff.select_driver(driver,p1.a28,my.a28)
        ff.select_driver(driver,p1.a30,my.a30)
        ff.select_driver(driver,p1.a32,my.a32)
        ff.select_driver(driver,p1.a33,my.a33)
        ff.select_driver(driver,p1.a34,my.a34)
        ff.select_driver(driver,p1.a37,my.a37)
        ff.select_driver(driver,p1.a38,my.a38)  
